...
#
# ultranet_vivado.tcl: Tcl script for re-creating project 'ultranet_vivado'
#
# Generated by Vivado on Fri Jun 19 21:17:00 +0800 2020
...
#
# 1. This project restoration tcl script (ultranet_vivado.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/KK/Desktop/FPGA/vivado_prj/ultranet_vivado/ultranet_vivado.srcs/sources_1/bd/ultranet_bd/hdl/ultranet_bd_wrapper.v"
#
...
set _xil_proj_name_ "ultranet_vivado"
...
set script_file "ultranet_vivado.tcl"
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../../FPGA_hls_code/hls_prj/ultranet640/solution1"]" $obj
...
set files [list \
 [file normalize "${origin_dir}/ultranet_vivado.srcs/sources_1/bd/ultranet_bd/hdl/ultranet_bd_wrapper.v" ]\
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "ultranet_bd_wrapper" -objects $obj
...
# Proc to create BD ultranet_bd
proc cr_bd_ultranet_bd { parentCell } {
...
# End of cr_bd_ultranet_bd()
cr_bd_ultranet_bd ""
set_property REGISTERED_WITH_MANAGER "1" [get_files ultranet_bd.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files ultranet_bd.bd ] 
